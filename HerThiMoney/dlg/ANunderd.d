...
== VICONIJ IF ~InParty("Viconia") !Dead("Viconia") InMyArea("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID)~ THEN @32
== JAHEIRAJ IF ~InParty("Jaheira") !Dead("Jaheira") InMyArea("Jaheira") !StateCheck("Jaheira",CD_STATE_NOTVALID)~ THEN @33
== CERNDJ IF ~InParty("Cernd") !Dead("Cernd") InMyArea("Cernd") !StateCheck("Cernd",CD_STATE_NOTVALID) InParty("Jaheira") !Dead("Jaheira") InMyArea("Jaheira") !StateCheck("Jaheira",CD_STATE_NOTVALID)~ THEN @34
== CERNDJ IF ~InParty("Cernd") !Dead("Cernd") InMyArea("Cernd") !StateCheck("Cernd",CD_STATE_NOTVALID) OR(4) !InParty("Jaheira") Dead("Jaheira") !InMyArea("Jaheira") StateCheck("Jaheira",CD_STATE_NOTVALID)~ THEN @33
== JAHEIRAJ IF ~InParty("Jaheira") !Dead("Jaheira") InMyArea("Jaheira") !StateCheck("Jaheira",CD_STATE_NOTVALID) Global("JaheiraRomanceActive","GLOBAL",2)~ THEN @35 DO ~SetGlobal("JaheiraRomanceActive","GLOBAL",3)~
== HAERDAJ IF ~InParty("HaerDalis") InMyArea("HaerDalis") !Dead("HaerDalis") !StateCheck("HaerDalis",CD_STATE_NOTVALID)~ THEN @36
== KORGANJ IF ~InParty("Korgan") InMyArea("Korgan") !Dead("Korgan") !StateCheck("Korgan",CD_STATE_NOTVALID)~ THEN @37
= @38
== MINSCJ IF ~InParty("Minsc") !Dead("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @39
END
IF ~~ THEN EXIT
...
== VICONIJ IF ~InParty("Viconia") InMyArea("Viconia") !Dead("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID)~ THEN @45
=@46
END

INTERJECT_COPY_TRANS UDDROW12 2 ANDevirViconia2
== VICONIJ IF ~InParty("Viconia") InMyArea("Viconia") !Dead("Viconia") !StateCheck("Viconia",CD_STATE_NOTVALID)~ THEN @47
END