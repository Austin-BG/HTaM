...
== KORGANJ IF ~Global("ANtorgalAll","GLOBAL",0) InParty("Korgan") InMyArea("Korgan") !StateCheck("Korgan",CD_STATE_NOTVALID)~ THEN @2
...
== MINSCJ IF ~Global("ANtorgalAll","GLOBAL",0) InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID) InParty("Korgan") InMyArea("Korgan") !StateCheck("Korgan",CD_STATE_NOTVALID) OR(3) !InParty("Imoen2") !InMyArea("Imoen2") StateCheck("Imoen2",CD_STATE_NOTVALID)~ THEN @3
== KORGANJ IF ~Global("ANtorgalAll","GLOBAL",0) InParty("Korgan") InMyArea("Korgan") !StateCheck("Korgan",CD_STATE_NOTVALID) InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID)~ THEN @4
== MINSCJ IF ~Global("ANtorgalAll","GLOBAL",0) InParty("Minsc") InMyArea("Minsc") !StateCheck("Minsc",CD_STATE_NOTVALID) InParty("Korgan") InMyArea("Korgan") !StateCheck("Korgan",CD_STATE_NOTVALID)~ THEN @5
...
== TORGAL @10 DO ~SetGlobal("ANtorgalAll","GLOBAL",1)~
END
